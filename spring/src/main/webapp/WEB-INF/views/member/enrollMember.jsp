...
<div id="enroll-container">
        <%--  <form name="memberEnrollFrm" method="post" action="${path}/member/enrollMemberEnd.do">
            ...
            <input type="tel" class="form-control" placeholder="전화번호 (예:01012345678)" name="phone" id="phone" maxlength="11" >
          ...
          <springform:form modelAttribute="member" name="memberEnrollFrm" method="post" action="${path}/member/enrollMemberEnd.do">
